...
const en: Record<string, string> = {
  ...
  "nav.settingsDesc": "Customize chart color preferences.",
  "nav.colorPreference": "Red/Green Color Preference",
  "nav.colorModeGreenUp": "Green Up / Red Down",
  "nav.colorModeRedUp": "Red Up / Green Down",
  ...
  "strategy.advancedModuleIndicators": "Technical Indicators",
...
const zh: Record<string, string> = {
  ...
  "nav.settingsDesc": "自定义图表红绿配色偏好。",
  "nav.colorPreference": "红绿代表色偏好",
  "nav.colorModeGreenUp": "涨绿跌红",
  "nav.colorModeRedUp": "涨红跌绿",
  ...
  "strategy.advancedModuleIndicators": "技术指标",
